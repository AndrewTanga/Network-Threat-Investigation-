...
Recommendations
1.Immediately isolate the affected host and perform a full forensic investigation or reimage the system.
2.Hunt for IOCs (domains, IPs, file hash) across enterprise telemetry to identify additional compromised hosts.
3.Block known malicious domains and IPs at network and proxy layers where feasible.
